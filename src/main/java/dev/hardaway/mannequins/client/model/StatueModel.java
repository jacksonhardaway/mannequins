...
public class StatueModel extends DummyModel implements TranslatedHumanoid {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition stand = modelRoot.addOrReplaceChild("stand", CubeListBuilder.create().texOffs(24, 16).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 12.0F, 4.0F, false), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition root = stand.addOrReplaceChild("root", CubeListBuilder.create(), PartPose.offset(0.0F, -12.0F, 0.0F));

        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, false), PartPose.offset(0.0F, -10.0F, 0.0F));
